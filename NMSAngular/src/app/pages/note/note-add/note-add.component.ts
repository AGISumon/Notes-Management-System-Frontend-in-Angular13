...
export class NoteAddComponent implements OnInit {
  form!: FormGroup;
  isDisplayNoteDetails: any;
  isDisplayTime: any;
  isDisplaybookmarkUrl: any;
  checkNoteType: any;
  constructor(
  ...
  fieldChange(noteType: any) {
    if(noteType == 'Regular Note') {
      this.checkNoteType = 'Regular Note';
      this.isDisplayNoteDetails = true;
      this.isDisplayTime = false;
      this.isDisplaybookmarkUrl = false;
      ...
      this.checkNoteType = 'Bookmark';
      this.isDisplayNoteDetails = false;
      this.isDisplayTime = false;
      this.isDisplaybookmarkUrl = true;
